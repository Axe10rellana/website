<?php
session_start();
$url_base = "http://localhost/proyectos/website/";
$url_admin = "http://localhost/proyectos/website/admin/";
...
<html lang="es">
	 <head>
		  ...
		  <link rel="icon" type="image/x-icon" href="<?php echo $url_base; ?>assets/icons/favicon.png" />
		  <link rel="favicon" type="image/x-icon" href="<?php echo $url_base; ?>assets/icons/favicon.png" />
    	<link rel="apple-touch-icon" type="image/x-icon" href="<?php echo $url_base; ?>assets/icons/favicon.png" />
